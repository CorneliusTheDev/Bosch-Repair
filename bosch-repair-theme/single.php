        ...
        <div class="content-grid">
            ...
            <article class="main-content">
                ...
                <div class="notice notice-warning" style="margin-top:40px;">
                    <strong>⚠️ Need Help?</strong> If the error code hasn't resolved after basic troubleshooting, call our certified Bosch technicians at <a href="tel:<?php echo BRP_PHONE_RAW; ?>"><?php echo BRP_PHONE; ?></a> for professional diagnosis and same-day repair.
                </div>
                <?php endif; ?>
                ...
                <div style="background:var(--color-light);border-radius:var(--border-radius);padding:24px;margin-top:48px;display:flex;gap:16px;align-items:flex-start;">
                    <div style="width:56px;height:56px;background:var(--color-primary);border-radius:50%;display:flex;align-items:center;justify-content:center;color:white;font-size:1.5rem;flex-shrink:0;">👨‍🔧</div>
                    <div>
                        <strong style="display:block;margin-bottom:4px;">Written by a Certified Bosch Technician</strong>
                        <p style="color:var(--color-gray);font-size:0.875rem;margin:0;">All articles on this blog are written or reviewed by our factory-trained Bosch appliance repair technicians with hands-on experience diagnosing and fixing these machines.</p>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <aside class="sidebar">
                ...
                <?php if ( $post_type === 'error_code' || $post_type === 'guide' ) : ?>
                <div class="sidebar-widget">
                    ...
                    <div class="sidebar-widget-body">
                        ...
                        if ( $related->have_posts() ) :
                            echo '<ul class="footer-links" style="gap:8px;">';
                            while ( $related->have_posts() ) : $related->the_post();
                                echo '<li><a href="' . get_permalink() . '" style="color:var(--color-text);">' . get_the_title() . '</a></li>';
                            endwhile;
                            echo '</ul>';
                            wp_reset_postdata();
                        endif;
