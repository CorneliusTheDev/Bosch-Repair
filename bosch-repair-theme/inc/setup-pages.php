 ...
 *
 * HOW TO USE:
 * 1. Upload this theme to /wp-content/themes/bosch-repair-theme/
...
function brp_setup_create_cpt( $post_type, $title, $slug, $template = '', $meta = array(), $tax = array() ) {
    global $log;
...
brp_setup_create_page( 'Privacy Policy', 'privacy-policy', 'page-templates/template-legal.php',
    ...
    <p>Bosch Repair Pro ("Company", "we", "us", or "our") is committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.</p>
...
brp_setup_create_page( 'Terms of Use', 'terms-of-use', 'page-templates/template-legal.php',
    '<h2>Terms of Use</h2>
    <p><strong>Effective Date:</strong> January 1, 2024</p>
    <p>By accessing and using the Bosch Repair Pro website and services, you agree to be bound by these Terms of Use. Please read them carefully.</p>
    <h3>Services</h3>
    <p>Bosch Repair Pro provides independent appliance repair services. We are not affiliated with, authorized by, or endorsed by BSH Home Appliances Corporation or Robert Bosch GmbH. The Bosch name and related trademarks are used for identification purposes only.</p>
...
brp_setup_create_page( 'Mobile Terms of Use', 'mobile-terms-of-use', 'page-templates/template-legal.php',
    ...
    <p><strong>Effective Date:</strong> January 1, 2024</p>
    <p>These Mobile Terms of Use govern your use of Bosch Repair Pro\'s mobile services, including SMS/text message communications and mobile website access.</p>
    <h3>SMS / Text Message Service</h3>
    <p>By providing your mobile phone number and opting in, you consent to receive text messages from Bosch Repair Pro regarding appointment confirmations, reminders, and service updates. Message and data rates may apply.</p>
    <h3>Opt-Out</h3>
...
// ============================================================
$services = array(
    array( 'title' => 'Bosch Washer Repair',       'slug' => 'bosch-washer-repair',       'appliance' => 'washer' ),
    array( 'title' => 'Bosch Dryer Repair',         'slug' => 'bosch-dryer-repair',         'appliance' => 'dryer' ),
    array( 'title' => 'Bosch Dishwasher Repair',    'slug' => 'bosch-dishwasher-repair',    'appliance' => 'dishwasher' ),
    array( 'title' => 'Bosch Refrigerator Repair',  'slug' => 'bosch-refrigerator-repair',  'appliance' => 'refrigerator' ),
    array( 'title' => 'Bosch Oven Repair',          'slug' => 'bosch-oven-repair',          'appliance' => 'oven' ),
    array( 'title' => 'Bosch Range Repair',         'slug' => 'bosch-range-repair',         'appliance' => 'oven' ),
    array( 'title' => 'Bosch Cooktop Repair',       'slug' => 'bosch-cooktop-repair',       'appliance' => 'cooktop' ),
    array( 'title' => 'Bosch Freezer Repair',       'slug' => 'bosch-freezer-repair',       'appliance' => 'freezer' ),
    array( 'title' => 'Bosch Ice Maker Repair',     'slug' => 'bosch-ice-maker-repair',     'appliance' => 'refrigerator' ),
    array( 'title' => 'Bosch Microwave Repair',     'slug' => 'bosch-microwave-repair',     'appliance' => 'microwave' ),
    array( 'title' => 'Bosch Wall Oven Repair',     'slug' => 'bosch-wall-oven-repair',     'appliance' => 'oven' ),
    array( 'title' => 'Bosch Speed Oven Repair',    'slug' => 'bosch-speed-oven-repair',    'appliance' => 'oven' ),
);
...
$appliance_terms = array( 'dishwasher', 'washer', 'dryer', 'refrigerator', 'oven', 'cooktop', 'microwave', 'freezer' );
...
brp_setup_create_page( 'Guides', 'guides', 'page-templates/template-guides.php' );
...
echo '<h2 style="color:#4ec9b0;">✅ Bosch Repair Pro – Setup Complete</h2>';
