 ...
 *
 * Used for individual Bosch appliance service pages.
 * e.g. /services/bosch-washer-repair/
 *
...
$appliance_name = str_replace( array( 'Bosch ', ' Repair' ), '', $page_title );
?>
...
<section class="page-hero">
    <div class="container">
        ...
        <div style="display:flex;gap:16px;margin-top:24px;flex-wrap:wrap;">
            ...
            <a href="tel:<?php echo BRP_PHONE_RAW; ?>" class="btn btn-secondary" style="border-color:rgba(255,255,255,0.4);color:white;">📞 <?php echo BRP_PHONE; ?></a>
        </div>
    </div>
</section>
            ...
            <div class="main-content">
                ...
                <div class="entry-content">
                    ...
                    <ol>
                        ...
                        <li><strong>Expert Diagnosis:</strong> Our technician arrives on time with diagnostic tools and a full inventory of common Bosch parts.</li>
                        ...
                        <li><strong>Fast Repair:</strong> We complete the repair using factory-certified Bosch parts, usually within 1–2 hours.</li>
                    ...
                    <div class="notice notice-info">
                        <strong>💡 Tip:</strong> If your <?php echo esc_html( strtolower( $appliance_name ) ); ?> is displaying an error code, note it down before our technician arrives. You can also look it up in our <a href="<?php echo get_post_type_archive_link( 'error_code' ); ?>">Bosch Error Code Database</a>.
                    </div>
