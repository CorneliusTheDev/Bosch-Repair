...
$sample_guides = array(
    array(
        'title'    => 'Why Is My Bosch Dishwasher Not Draining? Complete Troubleshooting Guide',
        'slug'     => 'bosch-dishwasher-not-draining',
        'category' => 'Dishwasher',
        'excerpt'  => 'Step-by-step guide to diagnosing and fixing Bosch dishwasher drainage problems — from clogged filters to failed drain pumps.',
        'time'     => '8 min read',
    ),
    array(
        'title'    => 'How to Clean a Bosch Washing Machine: Complete Maintenance Guide',
        'slug'     => 'how-to-clean-bosch-washing-machine',
        'category' => 'Washer',
        'excerpt'  => 'Prevent mold, odors, and performance issues with our complete Bosch front-load washer cleaning and maintenance guide.',
        'time'     => '6 min read',
    ),
    array(
        'title'    => 'Bosch Refrigerator Leaking Water: 7 Common Causes and Fixes',
        'slug'     => 'bosch-refrigerator-leaking-water',
        'category' => 'Refrigerator',
        'excerpt'  => 'Find out why your Bosch refrigerator is leaking and how to fix it — from clogged defrost drains to faulty water inlet valves.',
        'time'     => '10 min read',
    ),
    array(
        'title'    => 'Bosch Oven Not Heating? Here\'s How to Diagnose the Problem',
        'slug'     => 'bosch-oven-not-heating',
        'category' => 'Oven',
        'excerpt'  => 'Learn the most common reasons a Bosch oven stops heating and how to determine if you need a new heating element, thermostat, or control board.',
        'time'     => '7 min read',
    ),
    array(
        'title'    => 'Bosch Dryer Not Drying Clothes: Causes and Solutions',
        'slug'     => 'bosch-dryer-not-drying',
        'category' => 'Dryer',
    ...
    array(
        'title'    => 'How to Reset Your Bosch Appliance: Full Model Guide',
        'slug'     => 'how-to-reset-bosch-appliance',
        'category' => 'All Appliances',
        'excerpt'  => 'Reset procedures for Bosch washers, dryers, dishwashers, refrigerators, ovens, and cooktops — model-specific instructions included.',
        'time'     => '5 min read',
    ),
);
...
<section class="page-hero">
    <div class="container">
        <?php brp_breadcrumbs(); ?>
        <h1>Bosch Appliance Repair Guides</h1>
        <p>Expert troubleshooting and maintenance guides written by our certified Bosch technicians. Find answers to common issues before calling for service.</p>
    </div>
</section>
...
<section class="section">
    <div class="container">
        ...
        <div style="background:var(--color-light);border-radius:var(--border-radius-lg);padding:48px;text-align:center;margin-top:64px;">
            ...
            <p style="color:var(--color-gray);max-width:500px;margin:0 auto 28px;">Our certified Bosch technicians are available same-day. If the guide didn't solve your problem, let us handle it professionally.</p>
