...
<section class="page-hero">
    <div class="container">
        ...
        <p><?php echo $cat_icon; ?> Bosch <?php echo esc_html( $cat_label ); ?> — Error Code <?php echo esc_html( $detail['code'] ); ?></p>
    </div>
</section>
                    ...
                    <div class="brp-ec-detail-header">
                        ...
                        <div>
                            ...
                            <p class="brp-ec-detail-appliance">
                                Bosch <?php echo esc_html( $cat_label ); ?> — Error Code <?php echo esc_html( $detail['code'] ); ?>
                            </p>
                        </div>
                    </div>
