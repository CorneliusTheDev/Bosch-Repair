# Monogram Repair Pro – WordPress Theme Installation Guide

## Theme Structure

```
monogram-repair-theme/
...
1. Zip the entire `monogram-repair-theme/` folder
...
```php
define( 'BRP_PHONE', '844-752-7887' );         // Display format
define( 'BRP_PHONE_RAW', '8447527887' );          // tel: link format
...
- **SEO Title**: e.g., "Monogram Washer Repair | Same-Day Service | Monogram Repair Pro"
- **Meta Description**: e.g., "Expert Monogram washer repair by certified technicians. Factory-certified parts, 90-day warranty, same-day service. Call 844-752-7887."
...
/services/monogram-washer-repair/             ← Individual service
/services/monogram-dryer-repair/
/services/monogram-dishwasher-repair/
/services/monogram-refrigerator-repair/
/services/monogram-oven-repair/
/services/monogram-range-repair/
/services/monogram-cooktop-repair/
/services/monogram-freezer-repair/
/services/monogram-ice-maker-repair/
/services/monogram-microwave-repair/
/services/monogram-wall-oven-repair/
/services/monogram-speed-oven-repair/
...
/error-codes/oven/
/guides/                                   ← Guides hub
/guides/monogram-dishwasher-not-draining/    ← Individual guide
/blog/                                     ← Blog hub
...
### Blog Posts (per Monogram.md: you will populate content)
...
> "Independent appliance repair service specializing in Monogram products. Professional diagnosis by experienced technicians. Not affiliated with or endorsed by Monogram. Brand names used for identification only."
