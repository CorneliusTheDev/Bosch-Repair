...
$recalls = array(
    array(
        'title'    => 'Monogram Dishwashers with Plastic Door Latch',
    ...
    array(
        'title'    => 'Monogram Heat Pump Dryers – Potential Overheating',
        ...
        'remedy'   => 'Consumers should stop using the dryer immediately and contact Monogram for a free in-home repair.',
        'cpsc_url' => 'https://www.cpsc.gov/Recalls',
    ),
    array(
        'title'    => 'Monogram Refrigerators – Defrost System Issue',
...
$recall_faqs = array(
    array(
        'q' => 'How do I know if my Monogram appliance has a recall?',
        'a' => 'Check the recall list on this page or visit CPSC.gov and search for "Monogram." You can also call our service line and provide your model number — we\'ll check recall status for you.'
    ),
    array(
    ...
    array(
        'q' => 'Who pays for repairs on recalled Monogram appliances?',
    ...
    array(
        'q' => 'Where do I find my Monogram model number?',
    ...
    array(
        ...
        'a' => 'Yes. While we are an independent service (not affiliated with Monogram), we are experienced in all recall-related repairs. We can also help you contact the manufacturer for warranty-covered recall service.'
    ),
);
?>
...
<section class="page-hero">
    <div class="container">
        ...
        <p>Stay informed about Monogram appliance safety recalls. Check if your appliance is affected and learn what action to take.</p>
    </div>
</section>
...
<section class="section">
    <div class="container">
        ...
        <div style="background:var(--color-light);border-radius:var(--border-radius-lg);padding:40px;margin-top:64px;">
            <h2 style="margin-bottom:16px;">How to Check If Your Monogram Appliance Is Recalled</h2>
            <div class="grid grid-2" style="gap:32px;align-items:start;">
                <div>
                    <ol style="display:flex;flex-direction:column;gap:16px;">
                        ...
                        <li><strong>Visit CPSC.gov</strong> and search "Monogram" for the most up-to-date list.</li>
                        <li><strong>Register your appliance</strong> with Monogram so they can notify you of future recalls.</li>
