...
$city_faqs = array(
    array(
        ...
        'a' => 'Yes! We offer same-day and next-day Monogram appliance repair appointments in ' . $city_name_only . ' and all surrounding suburbs. Call us before noon for the best chance at a same-day visit.',
    ),
    array(
    ...
    array(
        ...
        'a' => 'Repair costs vary based on the appliance type and issue. We provide upfront, fixed quotes before any work begins. Most Monogram appliance repairs in ' . $city_name_only . ' range from $150–$500 depending on parts required.',
    ),
    array(
        'q' => 'Are your ' . $city_name_only . ' technicians certified?',
        'a' => 'Yes. All our technicians are factory-trained, certified, and background-checked. They specialize specifically in Monogram appliances and receive regular training on new models and technologies.',
    ),
    array(
        'q' => 'Do you repair all Monogram appliance models in ' . $city_name_only . '?',
        'a' => 'We repair all Monogram appliance models including built-in refrigerators, pro ranges, wall ovens, dishwashers, cooktops, speed ovens, ice makers, wine reserves, and outdoor grills. We service both current and legacy models.',
    ),
);
?>
...
<div class="city-image-banner" style="position:relative;overflow:hidden;">
    ...
    <div style="position:absolute;inset:0;background:linear-gradient(to bottom, rgba(0,0,0,0.35) 0%, rgba(0,0,0,0.55) 100%);display:flex;align-items:center;">
        <div class="container" style="position:relative;z-index:1;color:#fff;">
            ...
            <p style="color:rgba(255,255,255,0.88);max-width:620px;">Professional <?php echo BRP_BRAND; ?> appliance repair serving <?php echo esc_html( $city_name_only ); ?> and surrounding suburbs. Same-day service available. Factory-certified parts and highly trained technicians.</p>
